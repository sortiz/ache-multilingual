...
public class TargetStorageConfig {
    ...
    @JsonProperty("target_storage.language_detection_enabled")
    private boolean languageDetectionEnabled = false;
    
    @JsonProperty("target_storage.languages")
    ...
    public boolean isLanguageDetectionEnabled() {
    ...
    public String getListLanguagesAsString() {
